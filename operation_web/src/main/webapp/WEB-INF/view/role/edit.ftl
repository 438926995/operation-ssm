...
<div class="content-wrapper">
	...
	<div class="box box-primary">
        ...
        <form id="role" action="${basePath}/role/editSave" method="post">
          <div class="box-body"> 
          	<#if rab??>  
              ...
              <#if rab??>  
			    <@spring.showErrors "<br>"/>  
          		...
          		<input type="text" required class="form-control" id="roleName" name="roleName" value="${(roleInfo.roleName)!}">
          	</div>
          	...
          	<div class="form-group">
	              ...
	              <input type="radio" name="isDefault" id="isDefault0" value="0" 
					<#if roleInfo??> 
					 <#if roleInfo.isDefault?? && "${roleInfo.isDefault}"=="0"> checked </#if> 
					<#else> checked </#if>
				  >否
	              <input type="radio" name="isDefault" id="isDefault1" value="1" <#if roleInfo?? && roleInfo.isDefault?? && "${roleInfo.isDefault}"=="1"> checked </#if> >是
	            </label>
          	</div>
