    ...
    <#-- Main content -->
        ...
        <#-- 融资产品添加页面 -->
            ...
            <div class="box box-primary">
                ...
                <form role="form" id="product" action="${basePath}/product/ruleAddSave" method="post"
                      data-parsley-validate="" enctype="multipart/form-data">
                    <div class="box-body">
                        <div class="form-group" id="fpNameDiv">
                            规则名称 &nbsp;
                            <input type="text" class="form-control" id="ruleName" name="ruleName" value="" required
                                   data-parsley-trigger="change" data-parsley-length="[2, 100]"
                                   data-parsley-maxlength="100">
                        </div>
                        <div class="form-group" id="fpNameDiv">
                            规则内容 &nbsp;
                            <input type="text" class="form-control" id="ruleContent" name="ruleContent" value=""
                                   required data-parsley-trigger="change" data-parsley-length="[2, 100]"
                                   data-parsley-maxlength="100">
                        </div>
