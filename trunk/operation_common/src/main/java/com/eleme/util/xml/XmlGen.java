 ...
 * 
 * If one would like to work on a subtree or a collection thereof , selectFirstXml() and
 * selectAllXml() will help.
 * 
 * 
...
public class XmlGen {
  ...
  /**
   * recursively get all the text node from the current XML. Used with selectFirst(All)Xml(), it
   * strips off tags from any part of an XML.
   * 
   ...
   *         1<span>2</span>3
   *         </p>
   *         </xml> text eg: allText = x.selectFirstXml("//p").getAllTextWithPreOrder(); result: 123
   */
