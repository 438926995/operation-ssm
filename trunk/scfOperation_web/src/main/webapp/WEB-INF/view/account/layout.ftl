              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    <div class="pull-left">
                      <a href="${basePath}/user/changePwd" class="btn btn-default btn-flat">修改密码</a>
                    </div>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview<#if parent.selected> active</#if>">
              ...
              <ul class="treeview-menu">
                ...
                <li<#if child.selected> class="active"</#if>><a href="${basePath}/${child.resourceString}"><i class="fa fa-circle-o"></i>${child.resourceName}</a></li>
                </#list>
                </#if>
              </ul>
            </li>
