...
<div class="content-wrapper">
	...
	<div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">审批流添加</h3>
        </div><!-- /.box-header -->
        <!-- form start -->
        
        <form role="form" id="apvTeam" action="${basePath}/flowmanage/addProcsSave" method="post" data-parsley-validate="" enctype="multipart/form-data">
          <div class="box-body"> 
