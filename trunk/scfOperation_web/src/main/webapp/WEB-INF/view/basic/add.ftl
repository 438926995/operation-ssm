...
<div class="content-wrapper">
	...
	<div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">基础数据添加</h3>
        </div><!-- /.box-header -->
        <!-- form start -->
        
        <form id="basicadd" action="${basePath}/basic/addSave" method="post" >
          <div class="box-body">
          	<input type="hidden" name="typeId" value="0" >
          	<input type="hidden" name="typeIdName" value="基本数据" >
              ...
              规则类型名称 &nbsp;<label for="typeCdName" id="typeCdNameLabel">
              <#if mbd??>  
