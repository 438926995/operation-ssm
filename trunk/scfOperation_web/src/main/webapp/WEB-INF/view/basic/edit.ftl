...
<div class="content-wrapper">
	...
	<div class="box box-primary">
        ...
        <form id="basicform" action="${basePath}/basic/editSave" method="post">
          <div class="box-body"> 
              ...
              <#if basic??>  
			    <@spring.showErrors "<br>"/>  
          		...
          		<input type="text" required class="form-control" id="sortIndex" name="sortIndex" value="${(basic.sortIndex)!}">
          	</div>
