...
<div class="content-wrapper">
	...
	<div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">金融机构编辑</h3>
        </div><!-- /.box-header -->
        <!-- form start -->
        
        <form role="form" id="finance" action="${basePath}/finance/editSave" method="post" data-parsley-validate="" enctype="multipart/form-data">
          <div class="box-body"> 
            <#if fab??>  
            ...
            <div class="form-group <@spring.errorStyle />" id="foLogoDiv">
            	...
            	<label for="foLogo" id="foLogoLabel">
              	...
              	<input style="display:none" onchange="checkUpload();" type="file" class="form-control" id="foLogo" name="foLogo" value="${fab.foLogo!!}" >
            </div>
            
            <#if fab??>  
				<@spring.bind "fab.foCoverCityNames" />  
			</#if>
            <div class="form-group <@spring.errorStyle /> " id="foCityDiv">
            	机构的覆盖城市&nbsp;
            	<label for="foCity" id="foCityLabel">
              	...
              	<button type="button" class="btn btn-primary" id="choose">编辑城市</button>
              	<input type="text" class="form-control" id="foCity" name="foCoverCityNames" value="${(fab.foCoverCityNames)!}" readonly="readonly" style="margin:5px;color:blue;">
             </div>
            ...
            <div class="form-group <@spring.errorStyle /> " id="foStatusDiv">
                ...
                <select name="foStatus" id="foStatus" required>
                	<option value=""  <#if fab.foStatus?? && "${fab.foStatus}"=="">selected="selected"</#if> >全部</option>
					<option value="0" <#if fab.foStatus?? && "${fab.foStatus}"=="0">selected="selected"</#if> >洽谈中</option>
				  	<option value="1" <#if fab.foStatus?? && "${fab.foStatus}"=="1">selected="selected"</#if> >合作中</option>
				  	<option value="2" <#if fab.foStatus?? && "${fab.foStatus}"=="2">selected="selected"</#if> >取消合作</option>
				</select>
            </div>
...
<script id="chooseCity" type="text/html">
	<div class="choosedCity" style="float:left;width:100%;height:auto;border:1px solid gray;margin-bottom:10px;padding:10px" >
	 		<div style="float:left;margin:5px;width:100%;text-align:left">已选城市：</div>
 			<br>
	...
	<div class="choosedProvs" style="float:left;width:100%;height:auto;border:1px solid gray;margin-bottom:10px;padding:10px;padding-left:20px;" >
	    <div style="float:left;margin:5px;width:100%;text-align:left">覆盖省份：</div>
	    <br>
...
<script id="pCitites" type="text/html">
	<div style="float:left;margin:5px;width:100%;text-align:left">城市列表：</div>
	<br>
	{{each list as city i}}
		<div style="float: left;width:20%;text-align:left;">
