...
<div class="content-wrapper">
	...
	<div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">融资产品所需材料添加</h3>
        </div><!-- /.box-header -->
        <!-- form start -->
        
        <form role="form" id="product" action="${basePath}/product/addMaterialSave" method="post" data-parsley-validate="">
          <div class="box-body"> 
            <#if pmab??>  
            ...
            <input type="hidden" name="ruleType" id = "ruleType" value="2">
