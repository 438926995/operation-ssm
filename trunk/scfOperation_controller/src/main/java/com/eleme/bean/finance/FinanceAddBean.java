 ...
 *
 */
@GroupSequence({First.class, Second.class, Third.class, Four.class, FinanceAddBean.class})
public class FinanceAddBean implements Serializable {
  ...
  @Single(field = "FO_NAME", tableName = "M_FINANCE_ORG", message = "{field.name}",
      groups = {Third.class})
  ...
  // 公司电话
  @Pattern(regexp = "^([0-9]{3,4}-)?[0-9]{7,8}$", message = "{field.phone}",
      groups = {First.class})
