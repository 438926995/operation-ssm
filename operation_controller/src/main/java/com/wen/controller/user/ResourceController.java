...
public class ResourceController extends BaseController {
  ...
  @InjectResource(name = "菜单列表", url = "resource/list", grade = 2, parentName = "用户管理",
      customProps = {"SHOW_NAV:1", "RESOURCE_DESC:菜单列表"})
  @UserMenu
  ...
  @UserMenu
  @InjectResource(name = "资源添加", url = "resource/add", grade = 3, parentName = "菜单列表",
      customProps = {"RESOURCE_DESC:资源添加"})
  ...
  @AvoidDuplicateSubmission(needSaveToken = true)
  @UserMenu
  @InjectResource(name = "资源编辑", url = "resource/edit", grade = 3, parentName = "菜单列表",
      customProps = {"RESOURCE_DESC:资源编辑"})
  ...
  @ResponseBody
  @InjectResource(name = "根据parentId获取其子菜单", url = "resource/children", grade = 3, parentName = "菜单列表")
  ...
  @UserMenu
  @InjectResource(name = "保存资源", url = "resource/save", grade = 3, parentName = "菜单列表")
