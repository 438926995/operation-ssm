package com.wen.dao.security.impl;
...
public class UserSecurityDaoImpl implements IUserSecurityDao {
	 ...
	 * log
	 */
	protected static final Logger log = LoggerFactory.getLogger(UserSecurityDaoImpl.class);
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.wen.dao.account.IUserLoginDao#findAllAuthorities()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.wen.dao.account.IUserLoginDao#findUsersSecurityByUserId(long,
	 * boolean)
	 */
	@Override
